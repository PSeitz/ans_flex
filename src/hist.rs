...
use crate::FSE_MAX_SYMBOL_VALUE;

pub type CountsTable = [u32; FSE_MAX_SYMBOL_VALUE as usize + 1];
pub type NormCountsTable = [i16; FSE_MAX_SYMBOL_VALUE as usize + 1];
...
mod tests {
    ...
    use crate::hist::count_blocked_unsafe;
    use crate::hist::count_multi;
